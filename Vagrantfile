...
Vagrant.configure(2) do |config|
  ...
  # config.vm.define "web01" do |host|
  #   host.vm.network :private_network, ip: "192.168.33.10"
  # end

  config.vm.define "ap01" do |host|
    host.vm.network :private_network, ip: "192.168.33.20"
  end

  config.vm.define "ap02" do |host|
    host.vm.network :private_network, ip: "192.168.33.21"
  end

  config.vm.define "sess01" do |host|
